...
import "github.com/wslyyy/systray"
import "github.com/wslyyy/systray/example/icon"
...
See [full API](https://pkg.go.dev/github.com/wslyyy/systray?tab=doc) as well as [CHANGELOG](https://github.com/fyne-io/systray/tree/master/CHANGELOG.md).
